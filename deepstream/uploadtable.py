...
class InsertDeleteEntity(object):
    def __init__(self):
        ...
        self.access_key = os.getenv("NA87sFNHn34ZtbFPqc4gz2syzPfyYagkQEf2zclxeIEez2jhr/ztdzG7ak0p0YTSFaNQIQ7Kz1JX+AStrsknWA==")
        self.endpoint_suffix = os.getenv("core.windows.net")
        self.account_name = os.getenv("griotstorageaccount")
