...
PATH_TO_FILE = r"./final" + timestr + ".zip"
source_folder = "./output_tracking"
destination_folder = "./output_tracking_temp"
...
def run_sample(device_client) :        
    ...
    shutil.make_archive('final' + timestr, 'zip', destination_folder)
    # Connect the client
